 ...
 * LeftTurnControl.h
 *
 * 杩欎釜鏂囦欢澹版槑宸﹁浆瀛愮郴缁熸椂搴忔帶鍒舵ā鍧椼€? *********************************************************************/

// 中文逐行说明：下面这一行保留原始代码 -> #ifndef ESP32_LEFT_TURN_CONTROL_H
#ifndef ESP32_LEFT_TURN_CONTROL_H
// 中文逐行说明：下面这一行保留原始代码 -> #define ESP32_LEFT_TURN_CONTROL_H
...
// 中文逐行说明：下面这一行保留原始代码 -> class LeftTurnControl {
class LeftTurnControl {
// 中文逐行说明：下面这一行保留原始代码 -> public:
public:
    // 中文逐行说明：下面这一行保留原始代码 -> LeftTurnControl();
    LeftTurnControl();
...
// 中文逐行说明：下面这一行保留原始代码 -> #endif // ESP32_LEFT_TURN_CONTROL_H

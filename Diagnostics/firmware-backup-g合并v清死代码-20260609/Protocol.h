...
// 注意：实物接线 SDA/SCL 与丝印相反，软件交换匹配（SensorDiag10 确认）。
#define DEPTH_I2C_ADDRESS     0x76
#define DEPTH_I2C_SDA         5   // 实物接到 IO5
#define DEPTH_I2C_SCL         4   // 实物接到 IO4
...
// IMU (EBIMU-9DOFV6) 串口参数。默认出厂 115200 8N1，ASCII 输出 Euler。
